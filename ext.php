...
class ext extends \phpbb\extension\base
{
	...
	protected $required_extensions = [
		'blitze/content' => 'https://www.phpbb.com/customise/db/extension/sitemaker_content'
	];
	...
	public function is_enableable()
	{
		...
		$this->user->add_lang_ext('blitze/tags', 'ext');

		$lang = $this->user->lang;
		$metadata = $this->get_metadata('blitze/tags');
